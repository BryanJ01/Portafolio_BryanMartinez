...
// Crear el contexto de la manera más sencilla posible
export const CarouselContext = createContext<{
    onCardClose: (index: number) => void;
    currentIndex: number;
} | undefined>(undefined); // Inicializado como undefined
...
export const Card = ({ card, index, layout = false }: { card: Card; index: number; layout?: boolean }) => {
    ...
    const { onCardClose, currentIndex } = context || { onCardClose: () => {}, currentIndex: 0};
                ...
                {open && (
                    <div className="fixed inset-0 h-screen z-50 overflow-auto">
                        ...
                        <motion.div
                            ...
                            className="max-w-5xl mx-auto bg-white dark:bg-neutral-800 h-fit z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
                        >
                            <button
                            ...
                            <motion.p
                                ...
                                className="text-2xl md:text-5xl font-semibold text-neutral-700 dark:text-gray-100 mt-4"
                            >
                                {card.title}
                            </motion.p>
                            <div className="py-10 text-black dark:text-gray-200" style={{ fontSize: '1.2rem', lineHeight: '1.6' }}>
