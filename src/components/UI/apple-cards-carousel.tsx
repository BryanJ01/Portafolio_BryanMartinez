...
// Updated hook to fix the type error
export const useOutsideClick = (
  // Change the type to accept RefObject<HTMLDivElement | null>
  ref: React.RefObject<HTMLDivElement | null>,
  callback: () => void,
) => {
  useEffect(() => {
    const listener = (event: MouseEvent | TouchEvent) => {
      // Check if ref and ref.current exist before using them
    ...
    <>
      ...
      >
        ...
        <img
          ...
          alt={card.title}
          // Change className to class for Astro compatibility
